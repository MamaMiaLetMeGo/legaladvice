            ...
            <form action="{{ route('admin.posts.update', $post) }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                        ...
                        <div class="mt-1">
                            ...
                            @else
                                <input type="text" value="{{ auth()->user()->name }}"
                                    class="block w-full rounded-md border-gray-300 bg-gray-50 shadow-sm" disabled>
                    ...
                    <div class="sm:col-span-6">
                        ...
                        <div class="mt-1 flex items-center">
                            <div class="featured-image-preview {{ $post->featured_image ? '' : 'hidden' }} relative">
                                <img src="{{ $post->featured_image_url }}" alt="Featured image preview"
                    ...
                    <div class="sm:col-span-6">
                        ...
                        <textarea name="body_content" id="basic-example" cols="30" rows="10">{{ old('body_content', $post->body_content) }}</textarea>
                        {{-- <div class="mt-1">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mt-1 flex items-center">
                            <div class="video-preview {{ $post->video ? '' : 'hidden' }} relative">
                                <video width="520" height="340" controls class="rounded-lg">
...
@push('scripts')
    ...
    <script src="https://cdn.tiny.cloud/1/ohrfrapuhu20w9tbmhnitg6kvecj2vouenborprjzguexqop/tinymce/7/tinymce.min.js"
            ...
            document.getElementById('featured_image').addEventListener('change', function(e) {
                if (e.target.files && e.target.files[0]) {
                    ...
                    reader.onload = function(event) {
                        ...
                        '0'; // Reset remove_image flag when new image is selected
                    };
